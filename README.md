...
- Лидирующая категория по выручке: **Electronics**
...
4. Количество проданных единиц по товарам.
5. Средний чек по месяцам.

Визуализации позволяют наглядно оценить изменение продаж, структуру выручки, различия между городами и динамику среднего чека.
...
- анализом LTV клиентов;
- когортным анализом;
- анализом RFM-сегментации;
- расчётом маржинальности товаров;
- анализом причин отменённых заказов;
- прогнозированием будущей выручки;
- созданием интерактивного дашборда в Power BI или Tableau.